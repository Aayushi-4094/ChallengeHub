package com.embark.ChallengApp.controller;

import com.embark.ChallengApp.Challenge;
import com.embark.ChallengApp.services.ChallengeService;
...
public class ChallengeController {
    ...
    public ResponseEntity<String> addChallenge(@RequestBody Challenge challenge){
        boolean isChallengeAdded  = challengeService.addChhallenge(challenge);
        if(isChallengeAdded){
    ...
    public ResponseEntity<String> updateChallenge(@PathVariable Long id, @RequestBody Challenge updatedChallenge){
        boolean isChallegeUpdated = challengeService.updateChallege(id, updatedChallenge);
        if(isChallegeUpdated){
